...
var diceimage=document.querySelector("#pic");
var rlbtn=document.getElementById("roll"); 
  ...
  holdbtn.addEventListener("click",score1);
		...
		{
		curr+=num;
		document.querySelector("#pic").src="../images/dice-6.png";
		...
		{
		curr+=num;
		document.querySelector("#pic").src="../images/dice-5.png";
		document.getElementById("current--0").innerHTML=curr;
		...
		{
                curr+=num;
		document.querySelector("#pic").src="../images/dice-4.png";
		document.getElementById("current--0").innerHTML=curr;
		...
		{
                 curr+=num;
		document.querySelector("#pic").src="../images/dice-3.png";
		document.getElementById("current--0").innerHTML=curr;
		...
		{
                 curr+=num;
		document.querySelector("#pic").src="../images/dice-2.png";
		document.getElementById("current--0").innerHTML=curr;
		...
		{
		document.querySelector("#pic").src="../images/dice-1.png";
		zero();
		}
		}
               /* function won()
