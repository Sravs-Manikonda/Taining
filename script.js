...
function score()
{
document.querySelector("#score--0").textContent=curr;
document.querySelector(".p1").textContent=0;
play2();
}
...
{
document.querySelector("#pic").src="/home/feuji/Downloads/js-codeing-challenge-main/dice-6.png";
document.querySelector(".p2").textContent=curr;
add();
}
...
function score()
{
document.querySelector("#score--1").textContent=curr;
document.querySelector(".p2").textContent=0;
}
